...
# def fifo_write(cur_IMU_raw_data):
    
    


def UDP_process():
    init_IMUdata_coll = init_for_IMUdata('/home/ubuntu/RealTimeKin/0_Wireless/SocketMonitoring/IMU_settings_test.txt')
    ...
    # rf = open(fifo_file_path,mode='r',encoding='utf-8')
    # print(rf)
    # os.close(fifo_file_path)                     
