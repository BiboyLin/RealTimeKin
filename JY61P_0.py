...
# def ReadIMU(IMUaddress):
#     head_gyro = JY61P(IMUaddress)
#     head_gyro.acceleration = head_gyro.get_acc()
#     head_gyro.gyro = head_gyro.get_gyro()
#     # return head_gyro
#     # # while(True):
#     # print(" Acc:  " + repr(head_gyro.get_acc()) + "\n", "Gyro: " + repr(head_gyro.get_gyro()) + "\n", "Angle:" + repr(head_gyro.get_angle()) + "\n")
#     #     # print(" Acc:  " + repr([head_gyro.acceleration]) + "\n", "Gyro: " + repr(head_gyro.get_gyro()) + "\n")
#     #     # time.sleep(0.2) 
#     return head_gyro
...
class JY61P(object):
    ...
    def get_gyro(self):
        try:
            ...
            self.gyro_x = self.gyro_x / (57.32484076)
            self.gyro_y = self.gyro_y / (57.32484076)
            self.gyro_z = self.gyro_z / (57.32484076)
